#!/bin/bash
######### Note: modified to add key5 to node1
set -u
set -e
...
do
    ...
    if [[ $i -le 4 ]]; then
        ...
        cp ${permNodesFile} qdata2/dd${i}/permissioned-nodes.json
...
cp keys/key5 qdata2/dd2/keystore
