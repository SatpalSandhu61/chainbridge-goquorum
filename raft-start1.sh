...
performValidation genesis1.json
...
do
    ...
    PRIVATE_CONFIG=ignore nohup geth --datadir qdata1/dd${i} ${ARGS} ${permissioned} --raftport ${raftPort} --rpcport ${rpcPort} --port ${port} 2>>qdata1/logs/${i}.log &
    #PRIVATE_CONFIG=qdata1/c${i}/tm.ipc nohup geth --datadir qdata1/dd${i} ${ARGS} ${permissioned} --raftport ${raftPort} --rpcport ${rpcPort} --port ${port} 2>>qdata1/logs/${i}.log &
done
