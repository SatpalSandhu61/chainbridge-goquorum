...
performValidation genesis2.json
...
do
    ...
    PRIVATE_CONFIG=ignore nohup geth --datadir qdata2/dd${i} ${ARGS} ${permissioned} --raftport ${raftPort} --rpcport ${rpcPort} --port ${port} 2>>qdata2/logs/${i}.log &
    #PRIVATE_CONFIG=qdata2/c${i}/tm.ipc nohup geth --datadir qdata2/dd${i} ${ARGS} ${permissioned} --raftport ${raftPort} --rpcport ${rpcPort} --port ${port} 2>>qdata2/logs/${i}.log &
done
